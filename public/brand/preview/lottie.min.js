'undefined' != typeof document &&
  ...
  (function (t, e) {
        ...
        ('enterFrame' === t &&
          ...
          'segmentStart' === t &&
            ...
            this.onSegmentStart.call(
              this,
              new C(t, this.firstFrame, this.totalFrames)
            ),
          'destroy' === t &&
            this.onDestroy &&
            this.onDestroy.call(this, new M(t, this)));
      }),
    ...
    var $ = (function () {
        ...
        function h(t) {
          for (var i = 0, a = t.target; i < s; )
            (e[i].animation === a &&
              (e.splice(i, 1), (i -= 1), (s -= 1), a.isPaused || f()),
              (i += 1));
        }
        function l(t, i) {
          if (!t) return null;
      ...
      tt = (function () {
        var t = {
            getBezierEasing: function (t, i, s, a, r) {
              var n =
                r ||
                ('bez_' + t + '_' + i + '_' + s + '_' + a).replace(/\./g, 'p');
              if (e[n]) return e[n];
              var o = new p([t, i, s, a]);
              return ((e[n] = o), o);
            },
          ...
          (p.prototype = {
            ...
            _calcSampleValues: function () {
              for (var t = this._p[0], e = this._p[2], a = 0; a < i; ++a)
                this._mSampleValues[a] = h(a * s, t, e);
            },
        ...
        return {
          getSegmentsLength: function (t) {
            var e,
              ...
              p = 0;
            for (e = 0; e < h - 1; e += 1)
              ((l[e] = i(r[e], r[e + 1], n[e], o[e + 1])),
                (p += l[e].addedLength));
            return (
              a &&
                h &&
                ((l[e] = i(r[e], r[0], n[e], o[0])), (p += l[e].addedLength)),
              (s.totalLength = p),
              s
            );
          },
          getNewSegment: function (e, i, s, a, r, n, h) {
            ...
            for (l = 0; l < m; l += 1)
              ((p[4 * l] =
                t.round(1e3 * (g * e[l] + y * s[l] + v * a[l] + b * i[l])) /
                1e3),
                (p[4 * l + 1] =
                  t.round(1e3 * (_ * e[l] + k * s[l] + P * a[l] + A * i[l])) /
                  1e3),
                (p[4 * l + 2] =
                  t.round(1e3 * (S * e[l] + x * s[l] + w * a[l] + D * i[l])) /
                  1e3),
                (p[4 * l + 3] =
                  t.round(1e3 * (C * e[l] + M * s[l] + T * a[l] + F * i[l])) /
                  1e3));
            return p;
          },
    ...
    function ht(t, e) {
      ...
      if (a.to) {
        n.bezierData ||
          (n.bezierData = rt.buildBezierData(a.s, r.s || a.e, a.to, a.ti));
        var F = n.bezierData;
        if (t >= M || t < T) {
          ...
          (n.__fnct
            ? (m = n.__fnct)
            : ((m = tt.getBezierEasing(a.o.x, a.o.y, a.i.x, a.i.y, a.n).get),
              (n.__fnct = m)),
            (p = m((t - T) / (M - T))));
          var I,
            L = F.segmentLength * p,
          ...
          for (
            d =
              e.lastFrame < t && e._lastKeyframeIndex === u ? e._lastPoint : 0,
              y = !0,
              f = F.points.length;
            y;
          ) {
    ...
    function ft(t) {
      ...
      if ('unidimensional' === this.propType)
        ((e = t * this.mult),
          ot(this.v - e) > 1e-5 && ((this.v = e), (this._mdf = !0)));
      else
    ...
    function yt(t, e, i, s) {
      ...
      for (
        this.v = h('float32', f), this.pv = h('float32', f), a = 0;
        a < f;
        a += 1
      )
        ...
        function e(t, e, i) {
          ...
          if (t < m[0].t - this.offsetTime)
            ...
            for (
              ...
              y < v - 1 ? (y += 1) : (b = !1);
            if (
              ((g = this.keyframesMetadata[y] || {}), (d = y), !(r = 1 === c.h))
            ) {
          ...
          for (
            h = e._length, l = s.i[0].length, i.lastIndex = d, n = 0;
            n < h;
            n += 1
          )
            for (o = 0; o < l; o += 1)
    ...
    if (Lt) {
      var zt = document.getElementsByTagName('script'),
        Ot = zt[zt.length - 1] || { src: '' };
      ((Rt = Ot.src ? Ot.src.replace(/^[^\?]+\??/, '') : ''),
        (function (t) {
    ...
    try {
      ('object' ===
        ('undefined' == typeof exports ? 'undefined' : Et(exports)) &&
    ...
    ((qt.prototype.initModifierProperties = function () {}),
      ...
      (qt.prototype.addShape = function (t) {
        if (!this.closed) {
          ...
          for (a = 0; a < d; a += 1)
            if (
              ...
              if (
                ...
                for (
                  l = this.releasePathsData(c.pathsData), o = 0;
                  o < h;
                  o += 1
                )
                  ((p = rt.getSegmentsLength(s.shapes[o])),
                    l.push(p),
                    (f += p.totalLength));
      ...
      (jt.prototype.addShapes = function (t, e, i) {
        ...
        for (
          ...
          for (
            h = f[s].lengths,
              i.c = d[s].c,
              r = d[s].c ? h.length : h.length + 1,
              a = 1;
            a < r;
            a += 1
          )
            if (c + (n = h[a - 1]).addedLength < e.s)
      ...
      r([qt], Wt),
      (Wt.prototype.initModifierProperties = function (t, e) {
        ((this.getValue = this.processKeys),
    ...
    var Xt = (function () {
      ...
      function e(t, e, i) {
        ...
        (e.sk &&
          ...
          e.o
            ? (this.o = vt.getProp(t, e.o, 0, 0.01, t))
            : (this.o = { _mdf: !1, v: 1 }),
          (this._isDirty = !0),
    ...
    function Ut(t, e, i) {
      return [Jt(t[0], e[0], i), Jt(t[1], e[1], i)];
    }
    function Zt(t, e, i, s) {
    ...
    function $t(t, e, i, s, a) {
      (a && he(t, e) && (e = Ut(t, s, 1 / 3)),
        a && he(i, s) && (i = Ut(t, s, 2 / 3)));
      var r = Zt(t[0], e[0], i[0], s[0]),
        n = Zt(t[1], e[1], i[1], s[1]);
      ((this.a = [r[0], n[0]]),
        (this.b = [r[1], n[1]]),
        (this.c = [r[2], n[2]]),
        (this.d = [r[3], n[3]]),
    ...
    function ie(t) {
      ...
      return [ee(e[0], t.t1, t.t), ee(e[1], t.t, t.t2)];
    }
    function se(t, e, i, s, a, r) {
      ...
      if (
        ...
        if (
          ...
          var h = ie(t),
            l = ie(e);
          (se(h[0], l[0], i + 1, s, a, r),
            se(h[0], l[1], i + 1, s, a, r),
            se(h[1], l[0], i + 1, s, a, r),
            se(h[1], l[1], i + 1, s, a, r));
        }
    }
    function ae(t, e) {
      return [
    ...
    function re(t, e, i, s) {
      var a = [t[0], t[1], 1],
        ...
        o = [s[0], s[1], 1],
        h = ae(ae(a, r), ae(n, o));
      return Kt(h[2]) ? null : [h[0] / h[2], h[1] / h[2]];
    }
    function ne(t, e, i) {
        ...
        var o = (n + 1) / (s + 1),
          h =
            2 === a
              ...
              : 0,
          l = e.normalAngle(o);
        (pe(t, e.point(o), l, r, i, h / (2 * (s + 1)), h / (2 * (s + 1))),
          (r = -r));
      }
      return r;
    }
    ...
    function ue(t, e) {
      var i, s, a, r, n, o, h;
      ((i = (h = ce(t.points[0], t.points[1], e))[0]),
        (s = h[1]),
        (a = (h = ce(t.points[1], t.points[2], e))[0]),
        (r = h[1]),
        (n = (h = ce(t.points[2], t.points[3], e))[0]),
        (o = h[1]));
      var l = re(i, s, a, r);
      null === l && (l = s);
      var p = re(n, o, a, r);
    ...
    function ge(t, e, i, s, a) {
      ...
      if (2 === s) {
        var o = -e.tangentAngle(1),
          ...
          l = re(
            r,
            ne(r, o + Math.PI / 2, 100),
            n,
            ne(n, o + Math.PI / 2, 100)
          ),
          p = l ? oe(l, r) : oe(r, n) / 2,
          f = ne(r, o, 2 * p * A);
        return (
      ...
      var d = re(
        he(r, e.points[2]) ? e.points[0] : e.points[2],
        r,
        n,
        he(n, i.points[1]) ? i.points[3] : i.points[1]
      );
      return d && oe(d, r) < a
    ...
    function ve(t, e) {
      var i = t.slice(),
        s = e.slice(),
        a = ye(t[t.length - 1], e[0]);
      return (
        a &&
          ((i[t.length - 1] = t[t.length - 1].split(a[0])[0]),
          (s[0] = e[0].split(a[1])[1])),
        t.length > 1 && e.length > 1 && (a = ye(t[0], e[e.length - 1]))
    ...
    function be(t, e) {
      ...
      if (1 === n.length || Gt(n[1], 1))
        return ((i = (a = t.split(n[0]))[0]), (s = a[1]), [ue(i, e), ue(s, e)]);
      i = (a = t.split(n[0]))[0];
      var o = (n[1] - n[0]) / (1 - n[0]);
      return (
        (r = (a = a[1].split(o))[0]),
        (s = a[1]),
        [ue(i, e), ue(r, e), ue(s, e)]
      );
    }
    function _e() {}
    function ke(t) {
    ...
    (r([qt], Ht),
      (Ht.prototype.initModifierProperties = function (t, e) {
        ((this.getValue = this.processKeys),
          ...
          (this.tr = Xt.getTransformProperty(t, e.tr, this)),
      ...
      ($t.prototype.split = function (t) {
        if (t <= 0) return [Qt(this.points[0]), this];
        if (t >= 1) return [this, Qt(this.points[this.points.length - 1])];
        var e = Ut(this.points[0], this.points[1], t),
          i = Ut(this.points[1], this.points[2], t),
          s = Ut(this.points[2], this.points[3], t),
          a = Ut(e, i, t),
          r = Ut(i, s, t),
          n = Ut(a, r, t);
        return [
      ...
      r([qt], le),
      (le.prototype.initModifierProperties = function (t, e) {
        ((this.getValue = this.processKeys),
      ...
      (le.prototype.processPath = function (t, e, i, s) {
        ...
        var n = -1,
          o = $t.shapeSegment(t, 0);
        de(r, t, 0, e, i, s, n);
        for (var h = 0; h < a; h += 1)
          ((n = me(r, o, e, i, s, -n)),
            (o = h !== a - 1 || t.c ? $t.shapeSegment(t, (h + 1) % a) : null),
            de(r, t, h + 1, e, i, s, n));
        return r;
      }),
      ...
      r([qt], _e),
      (_e.prototype.initModifierProperties = function (t, e) {
        ((this.getValue = this.processKeys),
          (this.amount = vt.getProp(t, e.a, 0, null, this)),
      ...
      (_e.prototype.processPath = function (t, e, i, s) {
        ...
        var l = [];
        for (r = 0; r < h; r += 1)
          ((o = $t.shapeSegment(t, r)), l.push(be(o, e)));
        if (!t.c)
          for (r = h - 1; r >= 0; r -= 1)
            ((o = $t.shapeSegmentInverted(t, r)), l.push(be(o, e)));
        l = (function (t) {
          for (var e, i = 1; i < t.length; i += 1)
            ((e = ve(t[i - 1], t[i])), (t[i - 1] = e[0]), (t[i] = e[1]));
          return (
            t.length > 1 &&
              ((e = ve(t[t.length - 1], t[0])),
              (t[t.length - 1] = e[0]),
              (t[0] = e[1])),
            t
          );
        ...
        for (r = 0; r < l.length; r += 1) {
          var d = l[r];
          for (
            f && (p = ge(a, f, d[0], i, s)), f = d[d.length - 1], n = 0;
            n < d.length;
            n += 1
          )
            ((o = d[n]),
    ...
    function Ve(t, e) {
      ...
      var a,
        r = s.length;
      for (i = 0; i < r; i += 1)
        ((a = new Re(s[i], e)), this.effectElements.push(a));
    }
    function Re(t, e) {
      this.init(t, e);
    }
    ...
    function qe() {}
    (r([bt], Re),
      (Re.prototype.getValue = Re.prototype.iterateDynamicProperties),
      ...
      (qe.prototype.checkLayers = function (t) {
        var e,
          i,
      ...
      (qe.prototype.setupGlobalData = function (t, e) {
        ((this.globalData.fontManager = new Pe()),
    ...
    ((We.prototype = {
      initTransform: function () {
        ...
        ((this.finalTransform = {
          mProp: this.data.ks
            ? Xt.getTransformProperty(this, this.data.ks, this)
            : { o: 0 },
          _matMdf: !1,
          _localMatMdf: !1,
          _opMdf: !1,
        ...
        if (this.renderableEffectsManager) {
          ...
          if (t.length) {
            ((this.localTransforms = []),
              (this.finalTransform.localMat = new Ft()));
            var e = 0,
              i = t.length;
    ...
    ((Je.prototype.renderFrame = function (t) {
      ...
      (Ue.prototype = {
        ...
        createRenderableComponents: function () {
          ((this.maskManager = new Xe(this.data, this, this.globalData)),
            (this.renderableEffectsManager = new Je(this)),
            ...
            if (1 === t || 3 === t) {
              ...
              (o.setAttribute('id', n),
                ...
                Ye.maskType ||
                  ...
                  (i = He.createFilter(e)),
                  this.globalData.defs.appendChild(i),
                  i.appendChild(He.createAlphaToLuminanceFilter()),
                  (r = W('g')).appendChild(a),
                  o.appendChild(r),
    ...
    var ii = { 1: 'butt', 2: 'round', 3: 'square' },
      si = { 1: 'miter', 2: 'round', 3: 'bevel' };
    function ai(t, e, i) {
      ((this.caches = []),
        (this.styles = []),
        (this.transformers = t),
    ...
    ((ai.prototype.setAsAnimated = function () {
      ...
      r([bt], hi),
      r([bt], li),
      (pi.prototype.comparePoints = function (t, e) {
      ...
      r([bt], pi),
      (fi.prototype.initGradientData = function (t, e, i) {
        ((this.o = vt.getProp(t, e.o, 0, 0.01, this)),
      ...
      (fi.prototype.setGradientOpacity = function (t, e) {
        if (this.g._hasOpacity && !this.g._collapsable) {
          ...
          (o.setAttribute(
            ...
            'gs' === t.ty &&
              (o.setAttribute('stroke-linecap', ii[t.lc || 2]),
              o.setAttribute('stroke-linejoin', si[t.lj || 2]),
          ...
          for (p = 0; p < u; p += 1) {
            if (((h = s.sh._mdf || a), s.styles[p].lvl < g)) {
              for (
                d = e.reset(),
                  m = g - s.styles[p].lvl,
                  c = s.transformers.length - 1;
                !h && m > 0;
              )
                ((h = s.transformers[c].mProps._mdf || h), (m -= 1), (c -= 1));
              if (h)
                for (
                  m = g - s.styles[p].lvl, c = s.transformers.length - 1;
                  m > 0;
                )
    ...
    (r([ze, We, Ue, ei, Ze, Oe, Qe], yi),
      (yi.prototype.initSecondaryElement = function () {}),
      (yi.prototype.identityMatrix = new Ft()),
      (yi.prototype.buildExpressionInterface = function () {}),
      ...
      (yi.prototype.createStyleElement = function (t, e) {
        ...
        return (
          ('st' !== t.ty && 'gs' !== t.ty) ||
            (r.setAttribute('stroke-linecap', ii[t.lc || 2]),
            r.setAttribute('stroke-linejoin', si[t.lj || 2]),
          ...
          t.bm && (r.style['mix-blend-mode'] = we(t.bm)),
      ...
      (yi.prototype.createGroupElement = function (t) {
        ...
        return (
          ...
          t.bm && (e.gr.style['mix-blend-mode'] = we(t.bm)),
          e
        );
      }),
      (yi.prototype.createTransformElement = function (t, e) {
        var i = Xt.getTransformProperty(this, t, this),
          s = new ci(i, i.o, e);
            ...
            'tr' === t[o].ty
              ...
              : 'sh' === t[o].ty ||
                ...
                : 'tm' === t[o].ty ||
                  ...
                  ? (d
                      ? ((f = e[o]).closed = !1)
                      : ((f = Bt.getModifier(t[o].ty)).init(this, t[o]),
                        (e[o] = f),
      ...
      (bi.prototype.defaultBoxWidth = [0, 0]),
      ...
      (bi.prototype.buildFinalText = function (t) {
        for (
          var e, i, s = [], a = 0, r = t.length, n = !1, o = !1, h = '';
          a < r;
        )
          ((n = o),
            (o = !1),
            (e = t.charCodeAt(a)),
            (h = t.charAt(a)),
            Pe.isCombinedCharacter(e)
              ? (n = !0)
              : e >= 55296 && e <= 56319
                ? Pe.isRegionalFlag(t, a)
                  ? (h = t.substr(a, 14))
                  : (i = t.charCodeAt(a + 1)) >= 56320 &&
                    i <= 57343 &&
                    (Pe.isModifier(e, i)
                      ? ((h = t.substr(a, 2)), (n = !0))
                      : (h = Pe.isFlagEmoji(t.substr(a, 4))
                          ? t.substr(a, 4)
                          : t.substr(a, 2)))
                : e > 56319
                  ? ((i = t.charCodeAt(a + 1)),
                    Pe.isVariationSelector(e) && (n = !0))
                  : Pe.isZeroWidthJoiner(e) && ((n = !0), (o = !0)),
            ...
            if (2 === d)
              ...
              6 === d
                ? (f === p
                    ...
                    : ((s = e(t(0, s + 0.5 - p), f - p)),
                      (l =
                        (1 + Math.cos(Math.PI + (2 * Math.PI * s) / (f - p))) /
                        2)),
                  (l = h(l)))
                : (s >= i(p) &&
                    (l = t(0, e(s - p < 0 ? e(f, 1) - (p - s) : f - s, 1))),
                  (l = h(l)));
            if (100 !== this.sm.v) {
    ...
    function ki(t, e, i) {
      ...
      ((this.a = {
        ...
        (this.s = _i.getTextSelectorProp(t, e.s, i)),
        (this.s.t = e.s.t));
    }
    function Pi(t, e, i) {
      ((this._isFirstFrame = !0),
    ...
    ((Pi.prototype.searchProperties = function () {
      ...
      for (t = 0; t < i; t += 1)
        ((e = this._textData.a[t]),
          (this._animatorsData[t] = new ki(this._elem, e, this)));
            ...
            if ((S.reset(), (W = 1), D[a].n))
              ...
              for (
                t.strokeWidthAnim && (H = t.sw || 0),
                  t.strokeColorAnim &&
                    (X = t.sc ? [t.sc[0], t.sc[1], t.sc[2]] : [0, 0, 0]),
                  ...
                  if (T.fc.propType)
                    for (G = 0; G < 3; G += 1)
                      L.length
                        ...
                        : (Y[G] += (T.fc.v[G] - Y[G]) * L);
                  (T.fh.propType &&
                    (Y = L.length ? O(Y, T.fh.v * L[0]) : O(Y, T.fh.v * L)),
                    T.fs.propType &&
                      (Y = L.length ? R(Y, T.fs.v * L[0]) : R(Y, T.fs.v * L)),
                    T.fb.propType &&
                      (Y = L.length ? z(Y, T.fb.v * L[0]) : z(Y, T.fb.v * L)));
                }
              }
              for (F = 0; F < E; F += 1)
                (T = P[F].a).p.propType &&
              ...
              if (
                ...
                if (
                  ...
                  (h.point[0] < m.point[0] && (dt += 180),
                    S.rotate((-dt * Math.PI) / 180));
                }
                (S.translate(q, j, 0),
                  (o -= k[0] * D[a].an * 0.005),
                  D[a + 1] &&
      ...
      (Pi.prototype.mHelper = new Ft()),
      (Pi.prototype.defaultPropsArray = []),
      r([bt], Pi),
      (Ai.prototype.initElement = function (t, e, i) {
        ((this.lettersChangedFlag = !0),
          this.initFrame(),
          this.initBaseData(t, e, i),
          (this.textProperty = new bi(this, t.t, this.dynamicProperties)),
          (this.textAnimator = new Pi(t.t, this.renderType, this)),
          this.initTransform(t, e, i),
          this.initHierarchy(),
          this.initRenderable(),
          this.initRendererElement(),
      ...
      (Ai.prototype.createPathShape = function (t, e) {
        ...
        for (i = 0; i < a; i += 1)
          'sh' === e[i].ty &&
            ((s = e[i].ks.k), (r += ui(s, s.i.length, !0, t)));
        return r;
      }),
    ...
    return (
        ...
        if (!f || h || i.sz) {
          ...
          for (t = 0; t < e; t += 1) {
            if (
              ...
              if (
                ((n = y > t ? this.textSpans[t].span : W(h ? 'g' : 'text')),
                y <= t)
              ) {
                if (
            ...
            if (
              ...
              if (
                ...
                b = new Fi(g.data, this.globalData, this);
              else {
                var _ = xi;
                (g.data &&
                  g.data.shapes &&
                  (_ = this.buildShapeData(g.data, i.finalSize)),
                  (b = new yi(_, this.globalData, this)));
              }
      ...
      r([$e], Di),
      (Di.prototype.createContent = function () {
        var t = W('rect');
      ...
      r([ze, We, Ze, Oe], Ci),
      r([qe], Mi),
      (Mi.prototype.createNull = function (t) {
      ...
      (Mi.prototype.findIndexByInd = function (t) {
        var e = 0,
      ...
      r([ze, We, Ze, Oe, Qe], Ti),
      (Ti.prototype.initElement = function (t, e, i) {
        (this.initFrame(),
          this.initBaseData(t, e, i),
          this.initTransform(t, e, i),
          this.initRenderable(),
      ...
      r([Mi], Ei),
      (Ei.prototype.createComp = function (t) {
        return new Fi(t, this.globalData, this);
      }),
      (Si = Ei),
      (U['svg'] = Si),
      Bt.registerModifier('tm', jt),
      Bt.registerModifier('pb', Wt),
      Bt.registerModifier('rp', Ht),
      Bt.registerModifier('rd', Yt),
      Bt.registerModifier('zz', le),
      Bt.registerModifier('op', _e),
      It
    );
  });
