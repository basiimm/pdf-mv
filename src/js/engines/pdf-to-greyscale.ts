// Pure engine for the pdf-to-greyscale tool. See docs/TOOL-MIGRATION-GUIDE.md.
...
/** Render scale to use, defaulting to the legacy 2.0x. */
export function resolveScale(options: PdfToGreyscaleOptions): number {
  return options.scale && options.scale > 0 ? options.scale : 2.0;
}
